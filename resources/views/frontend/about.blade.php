                    ...
                    <div class="col-md-12 col-xl-6">
                        <div class="about-three-left-box">
                            ...
                            <div class="about-first-img">
                                <img src="{{ asset('frontend/images/homepage-3/about-01.jpg') }}" class="img-fluid"
                                    alt="">
                            </div>
                            <div class="about-second-img">
                                <div class="img-wrap">
                                    <img src="{{ asset('frontend/images/homepage-3/about-02.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="about-three-right-box">
                            <div class="pbmit-heading-subheading">
                                ...
                                <div class="pbmit-heading-desc">
                                    At AnchorPointCargo, we pride ourselves on offering reliable logistics and
                                    transport solutions designed to save you time and streamline your operations. With a
                                    focus on efficiency and precision, we provide tailored services for businesses of
                                    all sizes, ensuring that your goods are delivered safely and on schedule. Our expert
                                    team, advanced technology, and extensive network allow us to handle even the most
                                    complex logistics challenges, so you can focus on what matters most—growing your
                                    business. Trust us to be your partner in seamless and dependable delivery.
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                                ...
                                                <div class="pbmit-ihbox-icon">
                                                    <div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
                                                        <svg enable-background="new 0 0 512 512" height="512"
                                                            ...
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <g
                                                                id="_x30_9_x2C__Box_x2C__delivery_x2C__fast_x2C__logistics_x2C__package">
                                                                <g id="XMLID_92_">
                                                                    <path id="XMLID_97_"
                                                                        d="m214.187 139.087h83.622v70.413h-83.622z">
                                                                    </path>
                                                                    <path id="XMLID_127_"
                                                                    ...
                                                                    <path id="XMLID_161_"
                                                                        d="m307.809 214.499c0 2.761-2.239 5-5 5h-93.622c-2.761 0-5-2.239-5-5v-75.413h-159.141v328.397h421.907v-328.396h-159.144zm45.495 63.645c.798-1.815 2.594-2.987 4.577-2.987s3.778 1.172 4.577 2.986c7.449 16.933 48.733 19.658 62.515 3.441 1.358-1.598 3.567-2.178 5.535-1.455 1.967.724 3.275 2.597 3.275 4.693 0 20.441.242 41.094.242 61.57 0 40.563-28.416 78.062-74.16 97.86-1.241.538-2.682.559-3.972 0-45.742-19.8-74.157-57.297-74.157-97.86 0-20.482.244-41.127.244-61.57 0-2.097 1.308-3.97 3.275-4.693s4.176-.142 5.535 1.455c13.753 16.184 55.055 13.518 62.514-3.44z">
                                                                    </path>
                                                                    <path id="XMLID_167_"
                            ...
                            <ul class="list-group style-2">
                                <li class="list-group-item">
                                    ...
                                    <span class="pbmit-icon-list-text">With over four decades of experience providing
                                        solutions</span>
                                </li>
                                <li class="list-group-item">
                                    <span class="pbmit-icon-list-icon">
                                    ...
                                    <span class="pbmit-icon-list-text">Professional and Qualified</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="pbmit-ihbox-headingicon">
                                <div class="pbmit-ihbox-icon">
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
                                        <img src="{{ asset('frontend/images/homepage-3/award/award-01.png') }}"
                    ...
                    <div class="pbmit-col-20">
                        <div class="pbmit-ihbox-style-10">
                            <div class="pbmit-ihbox-headingicon">
                                <div class="pbmit-ihbox-icon">
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
                                        <img src="{{ asset('frontend/images/homepage-3/award/award-02.png') }}"
                    ...
                    <div class="pbmit-col-20">
                        <div class="pbmit-ihbox-style-10">
                            <div class="pbmit-ihbox-headingicon">
                                <div class="pbmit-ihbox-icon">
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
                                        <img src="{{ asset('frontend/images/homepage-3/award/award-03.png') }}"
                    ...
                    <div class="pbmit-col-20">
                        <div class="pbmit-ihbox-style-10">
                            <div class="pbmit-ihbox-headingicon">
                                <div class="pbmit-ihbox-icon">
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
                                        <img src="{{ asset('frontend/images/homepage-3/award/award-04.png') }}"
                    ...
                    <div class="pbmit-col-20">
                        <div class="pbmit-ihbox-style-10">
                            <div class="pbmit-ihbox-headingicon">
                                <div class="pbmit-ihbox-icon">
                                    <div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
                                        <img src="{{ asset('frontend/images/homepage-3/award/award-05.png') }}"
                                ...
                                <div class="pbmit-fld-contents">
                                    <div class="pbmit-fld-wrap">
                                        ...
                                        <h4 class="pbmit-fid-inner">
                                            <span class="pbmit-fid-before"></span>
                                            <span class="pbmit-number-rotate numinate"
                                                data-appear-animation="animateDigits" data-from="0" data-to="150"
                                                data-interval="25" data-before="" data-before-style=""
                                                data-after="" data-after-style="">150</span>
                                    ...
                                    <div class="pbmit-fld-wrap">
                                        ...
                                        <h4 class="pbmit-fid-inner">
                                            ...
                                            <span class="pbmit-number-rotate numinate"
                                                ...
                                                data-interval="25" data-before="" data-before-style=""
                                                data-after="" data-after-style="">245</span>
                                            <span class="pbmit-fid"><span>k</span></span>
                                        </h4>
                                    </div>
                                    <div class="pbmit-fid-icon-title">
