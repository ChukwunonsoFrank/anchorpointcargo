					...
					<div class="col-md-12 col-xl-6">
						<div class="contact-us-left-area">
							<div class="pbmit-heading-subheading animation-style4">
								...
								<div class="pbmit-heading-desc">
									We are eager to hear feedback and learn how to improve our wide array of services for our customers both home and abroad.
								</div>
							</div>
							<div class="contact-bg-img">
								<img src="{{ asset('frontend/images/img.png') }}" alt="">
							</div>
						</div>
					</div>
					<div class="col-md-12 col-xl-6">
						<div class="contact-form-rightbox pbmit-bg-color-white">
							...
							<p style="font-size: 12px; font-weight: bold;">Your email address will not be published. Required fields are marked *</p>
						...
						<div class="pbmit-border-wrapper">
							<div class="pbmit-client-wrapper pbmit-client-with-hover-img">
								...
								<div class="pbmit-client-hover-img">
									<img src="{{ asset('frontend/images/client/client-global-01.png') }}" class="img-fluid" alt="">
								</div>
								<div class="pbmit-featured-img-wrapper">
									<div class="pbmit-featured-wrapper">
										<img src="{{ asset('frontend/images/client/client-dark-01.png') }}" class="img-fluid" alt="">
									</div>
								</div>
							</div>
						</div>
					...
					<article class="pbmit-client-style-1 col-md-4 col-lg-3 col-xl-2">
						<div class="pbmit-border-wrapper">
							<div class="pbmit-client-wrapper pbmit-client-with-hover-img">
								<h4 class="pbmit-hide">Client-01</h4>
								<div class="pbmit-client-hover-img">
									<img src="{{ asset('frontend/images/client/client-global-02.png') }}" class="img-fluid" alt="">
								</div>
								<div class="pbmit-featured-img-wrapper">
									<div class="pbmit-featured-wrapper">
										<img src="{{ asset('frontend/images/client/client-dark-02.png') }}" class="img-fluid" alt="">
									</div>
								</div>
							</div>
						</div>
					...
					<article class="pbmit-client-style-1 col-md-4 col-lg-3 col-xl-2">
						<div class="pbmit-border-wrapper">
							<div class="pbmit-client-wrapper pbmit-client-with-hover-img">
								<h4 class="pbmit-hide">Client-01</h4>
								<div class="pbmit-client-hover-img">
									<img src="{{ asset('frontend/images/client/client-global-03.png') }}" class="img-fluid" alt="">
								</div>
								<div class="pbmit-featured-img-wrapper">
									<div class="pbmit-featured-wrapper">
										<img src="{{ asset('frontend/images/client/client-dark-03.png') }}" class="img-fluid" alt="">
									</div>
								</div>
							</div>
						</div>
					...
					<article class="pbmit-client-style-1 col-md-4 col-lg-3 col-xl-2">
						<div class="pbmit-border-wrapper">
							<div class="pbmit-client-wrapper pbmit-client-with-hover-img">
								<h4 class="pbmit-hide">Client-01</h4>
								<div class="pbmit-client-hover-img">
									<img src="{{ asset('frontend/images/client/client-global-04.png') }}" class="img-fluid" alt="">
								</div>
								<div class="pbmit-featured-img-wrapper">
									<div class="pbmit-featured-wrapper">
										<img src="{{ asset('frontend/images/client/client-dark-04.png') }}" class="img-fluid" alt="">
									</div>
								</div>
							</div>
						</div>
					...
					<article class="pbmit-client-style-1 col-md-4 col-lg-3 col-xl-2">
						<div class="pbmit-border-wrapper">
							<div class="pbmit-client-wrapper pbmit-client-with-hover-img">
								<h4 class="pbmit-hide">Client-01</h4>
								<div class="pbmit-client-hover-img">
									<img src="{{ asset('frontend/images/client/client-global-05.png') }}" class="img-fluid" alt="">
								</div>
								<div class="pbmit-featured-img-wrapper">
									<div class="pbmit-featured-wrapper">
										<img src="{{ asset('frontend/images/client/client-dark-05.png') }}" class="img-fluid" alt="">
									</div>
								</div>
							</div>
						</div>
					...
					<article class="pbmit-client-style-1 col-md-4 col-lg-3 col-xl-2">
						<div class="pbmit-border-wrapper">
							<div class="pbmit-client-wrapper pbmit-client-with-hover-img">
								<h4 class="pbmit-hide">Client-01</h4>
								<div class="pbmit-client-hover-img">
									<img src="{{ asset('frontend/images/client/client-global-06.png') }}" class="img-fluid" alt="">
								</div>
								<div class="pbmit-featured-img-wrapper">
									<div class="pbmit-featured-wrapper">
										<img src="{{ asset('frontend/images/client/client-dark-06.png') }}" class="img-fluid" alt="">
									</div>
								</div>
							</div>
						</div>
