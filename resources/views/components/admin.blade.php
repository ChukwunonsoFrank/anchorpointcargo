...
<html>
    ...
    <meta
      name="description"
      content="Get a business edge with an award-winning, free business checking account from MTFinanceCorporation."
    />

    <meta
      name="keywords"
      content="mtfinancecorporation, mt finance corporation, mt-finance-corporation, best banking company, best financial assets manager, consulting firm, corporate financing firm, financial holdings, investment bank, investments, investment portfolio, crypto investment, crypto investment sites"
    />
    <meta name="author" content="MTFinanceCorporation" />
    <meta name="copyright" content="Copyright MTFinanceCorporation - 2022" />

    <script src="https://kit.fontawesome.com/7016607b5a.js" crossorigin="anonymous"></script>

    <link
      rel="stylesheet"
      href="{{ asset('admin/css/bootstrap-theme.min.css') }}"
    />
    <link
      rel="stylesheet"
    ...
    <link
      rel="stylesheet"
      href="{{ asset('admin/css/font-awesome.min.css') }}"
    />
    <link
      rel="stylesheet"
      href="{{ asset('admin/css/jquery.dataTables.min.css') }}"
    />
