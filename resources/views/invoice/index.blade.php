...
<head>
    ...
    <title>AnchorPointCargo Transaction Receipt</title>
            ...
            <div class="invoice-content-wrap" id="download_section" style="border: 1px solid #999;">
                ...
                <section class="agency-service-content car-invoice-content" id="car_booking">
                    <div class="container">
                        ...
                        <div class="invoice-owner-conte-wrap" style="margin-bottom: 2rem;">
                            <div class="invo-to-wrap">
                                <div class="invoice-to-content">
                                    <img src="{{ 'storage/' . $order->package_image }}" width="200" height="200">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="money-send-title-wrap hire-mt">
                            <h3 class="mtb-0 transfer-title inter-700 md-lg-font" style="color: #04359d">Customer Biodata</h3>
                            <div class="mon-sent-content-wrap">
                                <div class="mon-send-left-data">
                                    <div class="mon-send-col-one">
                                        <span class="mon-send-title sm-md-text b-text inter-500">Residential Address:</span>
                                        <span
                                            class="mon-send-desc sm-md-text second-color inter-400">{{ $order->receiver_residential }}</span>
                                    </div>
                                    <div class="mon-send-col-one">
                                        <span class="mon-send-title sm-md-text b-text inter-500">Fullname:</span>
                                        <span
                                            class="mon-send-desc sm-md-text second-color inter-400">{{ $order->receiver_fullname }}</span>
                                    </div>
                                    <div class="mon-send-col-one">
                                        <span class="mon-send-title sm-md-text b-text inter-500">Email Address:</span>
                                        <span
                                            class="mon-send-desc sm-md-text second-color inter-400">{{ $order->receiver_email }}</span>
                                    </div>
                                    <div class="mon-send-col-one">
                                        <span class="mon-send-title sm-md-text b-text inter-500">Phone Number:</span>
                                        <span
                                            class="mon-send-desc sm-md-text second-color inter-400">{{ $order->receiver_phone }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rest-payment-bill">
                            <div class="payment-wrap payment-wrap-car" style="width: 100%">
                                <table class="res-pay-table" style="width: 100%">
                                    <tbody>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Package:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
												{{ $order->packaging }}
                                            </td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Carrier:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ $order->carrier }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Status:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ $order->status }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Total Freight:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ $order->total_freight }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Weight(Kg):</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ $order->weight }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Star Points:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ $order->star_points }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Shipment Mode:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ $order->shipment_mode }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Depature Date:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ date("F j, Y", strtotime(substr($order->depature_date, 0, 10))) }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Delivery Date:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ date("F j, Y", strtotime(substr($order->delivery_date, 0, 10))) }}</td>
                                        </tr>
                                        <tr class="pay-data">
                                            <td class="pay-type inter-700 medium-font b-text">Pickup Date:</td>
                                            <td class="refund-days inter-400 second-color" style="font-size: 14px;">
                                                {{ date("F j, Y", strtotime(substr($order->pickup_date, 0, 10))) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
