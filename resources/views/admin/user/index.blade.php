                ...
                <tbody>
                  @foreach($users as $user)
                    <tr>
                      ...
                      <td>
                        @if ($user->restricted) { %>
                          <a href="/admin/users?togglesuspend=true&id=<%= user.id %>" class="btn btn-sm btn-warning">
                            Ban
                          </a>
                        @else
                          <a href="/admin/users?togglesuspend=true&id=<%= user.id %>" class="btn btn-sm btn-success">
                            Free
                          </a>
                        @endif
                      </td>
