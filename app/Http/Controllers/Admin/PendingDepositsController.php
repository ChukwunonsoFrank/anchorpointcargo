...
class PendingDepositsController extends Controller
{
    ...
    public function approve(Request $request) {
        ...
        // Mail::to($user->email)->send(new DepositApproved($user->username, $deposit->amount, $deposit->payment_method, $deposit->payment_hash, $deposit->hash, $deposit->confirmation_status));
        return back();
    }
